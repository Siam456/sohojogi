                                                ...
                                                <a key={index} href={`/shop/${value._id}`} className="col-sm cardWrapperAll">
                                                    ...
                                                    <div className="card m-3" style={{width: '18rem'}} >
                                                        ...
                                                        <div className="card-body">
                                                            <h5 className="card-title" style={{color: '#7A8FA8'}}>{value.shopname}</h5>
                                                            <p className='text-muted'><i style={{color: '#348bb3'}} className="fas fa-grip-horizontal"></i> {value.catagory}</p>
                                                            <h6 className='text-muted'><i style={{color: '#D04545'}} className="fas fa-map-marker-alt"></i> {value.address}</h6>
