        ...
        <>
            <div>
                <div className='container'>
                    <div className='xs'>
                        <h3><i className="fab fa-block"></i>Control Products</h3>
                        <input className='form-control iSearch' type='text' onChange={searchShop} placeholder='Search shop/location...' />
                    </div>
                        ...
                        {shop.map((value, index) => {
                            ...
                            let cardWrapper = ''
                                if(value.products.length>0){
                                    ...
                                    location = <h6><i style={{color: '#D04545'}} className="fas fa-map-marker-alt"></i> {value.address}</h6>
                            ...
                            if(searchSHop !== ''){
                                ...
                                if(value.shopname.includes(searchSHop) || locationDatabase.includes(locationinput)){
                                    return(
                                        <div key={index}>
                                            <div className={cardWrapper}>
                                                ...
                                                {value.products.map((p, i) => {
                                                    ...
                                                    let productImg;
                                                    if(p.avater === null){
                                                        productImg = <img style={{ marginBottom: '20px' , borderRadius: '3px'}} src='https://images.unsplash.com/photo-1544148103-0773bf10d330?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjN8fHJlc3RhdXJhbnR8ZW58MHx8MHx8&ixlib=rb-1.2.1&w=1000&q=80' height='80px' width='80px' />
                                                    } else{
                                                            ...
                                                            <div className="cardX" type="button" data-toggle="modal" data-target="#exampleModalLong">
                                                                <div className="card-d">
                                                                        ...
                                                                        <div className="card-d-wi">
                                                                            <span style={{ fontWeight: "bold" }}><i style={{color: '#DC6B29'}} className="fas fa-pizza-slice"></i> {p.title}</span>
                                                                            <br />
                                                                            <span style={{ color: "gray", width: "auto" }}>{trimmedString}...</span>
                                                                            <br />
                                                                            <br />
                                                                            <h6 style={{ fontWeight: "bold"}}><i className="fas fa-tags"></i> tk {p.price}</h6>
                                                                ...
                                                                <button className="card-b">
                                                                        <i style={{color: '#1c2e4a'}} onClick={() => fetureProduct(p._id)} className={featureLogo}></i>
                                                                </button>
                                                                <button className="card-b" style={{marginLeft: '15px'}}>
                                                                    <i  style={{color: 'red'}} onClick={() => delProduct(p._id)} className="far fa-trash-alt"></i>
                                                                </button>
                                                            </div>
